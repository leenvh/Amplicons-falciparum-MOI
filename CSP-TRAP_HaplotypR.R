...
write.table(CSP_finalTab, file.path(outputDir, "CSP_finalTab.txt"), sep="\t", row.names=F, quote=F)
write.table(TRAP_finalTab, file.path(outputDir, "TRAP_finalTab.txt"), sep="\t", row.names=F, quote=F)
